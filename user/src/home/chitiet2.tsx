...
<div>
  ...
  <section className="package-detail">
    <div className="detail-container">
      <img src={Images.chitiet2} alt="Gói Đặt Phòng" className="package-image" />
      <div className="detail-info">
        <h2>Gói 2: Khách sạn + Tour Du Lịch</h2>
        <p><strong>Giá:</strong> <span className="amount">4.000.000 ₫</span></p>
        <p><strong>Mô tả:</strong> Khám phá thành phố với tour du lịch và nghỉ ngơi tại khách sạn. Gói này bao gồm các dịch vụ sau:</p>
        <ul>
          <li>2 đêm ở khách sạn 4 sao</li>
          <li>Tour du lịch miễn phí trong 1 ngày</li>
