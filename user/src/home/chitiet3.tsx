...
<div>
  ...
  <section className="package-detail">
    <div className="detail-container">
      <img src={Images.chitiet3} alt="Gói Đặt Phòng" className="package-image" />
      <div className="detail-info">
        <h2>Gói 3: Khách sạn + Vé Tham Quan</h2>
        <p><strong>Giá:</strong> <span className="amount">5.000.000 ₫</span></p>
        <p><strong>Mô tả:</strong> Kết hợp giữa nghỉ ngơi tại khách sạn và tham quan các địa điểm nổi tiếng. Gói này bao gồm các dịch vụ sau:</p>
        <ul>
          <li>3 đêm ở khách sạn 4 sao</li>
          <li>Vé vào cửa các điểm tham quan</li>
